...
class Application extends Silex\Application {
    ...
    {
        $this->register(new DerAlex\Silex\YamlConfigServiceProvider(PAWS_CONFIG_DIR . '/common.yml'));
        $this->register(new DerAlex\Silex\YamlConfigServiceProvider(PAWS_CONFIG_DIR . '/routing.yml'));
        $this->register(new DerAlex\Silex\YamlConfigServiceProvider(PAWS_CONFIG_DIR . '/menu.yml'));
        $this->register(
    ...
    public function initDatabase()
    {
        ...
        $this->register(new Silex\Provider\HttpCacheServiceProvider(), array(
            'http_cache.cache_dir' => PAWS_CACHE_DIR,
        ));
    }
